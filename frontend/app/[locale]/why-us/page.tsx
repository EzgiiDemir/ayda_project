...
export default async function WhyUsPage({ params }: Params) {
    ...
    const context = config.contextOverride ?? t('context');
                    ...
                    <div className="flex flex-col gap-7 md:gap-10 max-w-4xl mx-auto">
                        ...
                        <WhyUsSection title={t('sections.team.title')} icon="users">
                            ...
                            <WhyUsContent
                                content={
                                    <>
                                        <p className="mb-2 font-medium">{t('sections.team.embryology.title')}</p>
                            ...
                            <WhyUsContent
                                content={
                                    <>
                                        <p className="mb-2 font-medium">{t('sections.team.gynecology.title')}</p>
                                        <ul className="list-disc ml-6 space-y-1">
